...
Scope: Milestones 1, 1.5 and explicitly authorized 2A only: OSPF area mismatch plus incorrect default gateway. Do not add other Milestone 2 scenarios or start the remaining roadmap without explicit authorization. This nested folder is independent of the parent portfolio and sibling CaptainOS projects. Never modify their code to make NetFault work.
